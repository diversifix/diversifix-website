...
export const Verein = () => (
  <Page>
    <InputAreaContainer>
      <TextContainer>
        <h1>Wer sind wir und was machen wir?</h1>
        <h2>Unser Ziel</h2>
        <p>
        ...
        <h2>Wie erreichen wir das?</h2>
        <p>
          Durch 1. Sensibilisierung und durch 2. praktische Unterstützung bei
          ...
          <li>
            ...
            <ol>
              ...
              <li>
                ...
                <ol>
                  <li>
                    <b>Testing</b> in deiner Organisation oder deinem Team: wir
                  ...
                  <li>
                    <b>Input von Expert:innen</b> suchen wir, damit unsere
                  ...
                  <li>
                    <b>Austausch</b> suchen wir mit allen, die sich für das
        ...
        <p>
          ...
          <a
            href="https://tech.4germany.org/project/diversitaetssensible-sprache-bam/"
            target="_blank"
            rel="noreferrer"
          >
            eine prototypische Lösung
          </a>
