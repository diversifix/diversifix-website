...
export const WelcomeMessage = () => (
  <WelcomeMessageContainer>
    <WelcomeMessageIntroBox>
      ...
      <IntroTextColumn>
        <WelcomeMessageIntroLarge>
          Herzlich Willkommen bei DIVERSIFIX.
        </WelcomeMessageIntroLarge>
      </IntroTextColumn>
    </WelcomeMessageIntroBox>
    <WelcomeMessageBody>
      Prüfe Deine Texte auf Diversitätslücken. In welchem Stil du gendern
      möchtest, kannst du in den Einstellungen anpassen.
    </WelcomeMessageBody>
  </WelcomeMessageContainer>
);
